#ifndef TES4COMPILER_GENERATOR_H_INCLUDED
#define TES4COMPILER_GENERATOR_H_INCLUDED
...
namespace Tes4Compiler
{
    namespace Generator
    {
        ...
        void assignToMember (CodeContainer& code, Compiler::Literals& literals, char memberType,
        ...
        void fetchMember (CodeContainer& code, Compiler::Literals& literals, char memberType,
