...
namespace Tes4Compiler
{
    ...
    bool ControlParser::parseWhileBody (int keyword, const Compiler::TokenLoc& loc, Scanner& scanner)
    {
    ...
    ControlParser::ControlParser (Compiler::ErrorHandler& errorHandler, const Compiler::Context& context,
    ...
    bool ControlParser::parseName (const std::string& name, const Compiler::TokenLoc& loc, Scanner& scanner)
    {
    ...
    bool ControlParser::parseKeyword (int keyword, const Compiler::TokenLoc& loc, Scanner& scanner)
    {
    ...
    bool ControlParser::parseSpecial (int code, const Compiler::TokenLoc& loc, Scanner& scanner)
    {
